        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ClaudeApiKeyProtected = table.Column<string>(type: "TEXT", nullable: true),
                    ClaudeModel = table.Column<string>(type: "TEXT", nullable: true),
                    OpenAiApiKeyProtected = table.Column<string>(type: "TEXT", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ScorePercent = table.Column<double>(type: "REAL", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MaterialSections", x => x.Id);
                    table.ForeignKey(
                        name: "FK_MaterialSections_Materials_MaterialId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AllowsMultiple = table.Column<bool>(type: "INTEGER", nullable: false),
                    ...
                    SourceSectionId = table.Column<int>(type: "INTEGER", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Questions_MaterialSections_SourceSectionId",
                        column: x => x.SourceSectionId,
                        principalTable: "MaterialSections",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
                        name: "FK_Questions_Materials_SourceMaterialId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OptionOrder = table.Column<string>(type: "TEXT", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AttemptAnswers_AttemptId_Position",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Exams_UserId_TopicId",
                table: "Exams",
                columns: new[] { "UserId", "TopicId" });

            migrationBuilder.CreateIndex(
                name: "IX_MaterialSections_MaterialId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Materials_UserId_TopicId",
                table: "Materials",
                columns: new[] { "UserId", "TopicId" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Questions_SourceSectionId",
                table: "Questions",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Questions_UserId_TopicId_Type_Difficulty",
                table: "Questions",
                columns: new[] { "UserId", "TopicId", "Type", "Difficulty" });
